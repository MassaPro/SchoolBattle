...
class StupidGameActivityTwoPlayers : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val yourName = getSharedPreferences("UserData", Context.MODE_PRIVATE).getString("username", "").toString()
        ...
        val gameData =  myRef.child("StupidGames").child(if (opponentsName < yourName)
        ...
        gameData.addValueEventListener(object: ValueEventListener{
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                if (!p0.value.toString().contains(if (opponentsName < yourName)
                        "_1-" else "_2-")) {
