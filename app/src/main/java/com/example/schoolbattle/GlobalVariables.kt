...
var ARRAY_OF_DESIGN_SHOP: MutableList<Int>  = mutableListOf(0,1,2)             //номера  дизайнов в магазине
var ARRAY_OF_DESIGN: MutableList<Int>  = mutableListOf(0,2)             //номера открытых дизайнов
