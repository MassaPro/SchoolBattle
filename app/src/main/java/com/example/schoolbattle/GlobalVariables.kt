...
val PICTURE_STYLES = mapOf(0 to R.drawable.game_menu_normal, 1 to R.drawable.game_menu_egypt, 2 to R.drawable.game_menu_casino,3 to R.drawable.game_menu_rome,4 to R.drawable.game_menu_gothic,
...
val PRICE_OD_DESIGN = mapOf(0 to 10,1 to 20,2 to 30,3 to 1,4 to 1, 5 to 3, 6 to 10)
